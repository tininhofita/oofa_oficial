...
/**
 * Página de Integração com a Nuvemshop.
 ...
 */
export default function PaginaIntegracaoNuvemshop() {
  return (
    <div className="pagina-integracao">
      <div className="pagina-integracao__painel">
        ...
        <div className="pagina-integracao__marca">Nuvemshop</div>

        <p className="pagina-integracao__descricao">
          Estamos preparando a melhor experiência de sincronização para os seus pedidos, clientes e estoque da sua loja Nuvemshop. Em breve estará disponível!
        </p>
